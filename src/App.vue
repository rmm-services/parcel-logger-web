  ...
  methods: {
    addGoal() {
      const newitem = {
        ...
        riders_name: this.enteredFirstName + ' ' + this.enteredLastName,
    ...
    submit() {
      ...
      .then(response => {
        ...
        this.qr_value = response.data[0].message
  ...
  <div id="app">
    <form>
      ...
      <hr>
        ...
        <div class="qr" v-for="dr in dataResponse">
          <vue-qrcode :value="dr[0].rider_qr_details"/>
        </div>
